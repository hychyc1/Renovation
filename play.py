...
# gdf = gpd.read_file('data/朝阳区/villages.shp')
# gdf = gdf.drop(columns= ['geometry'])
# gdf.to_csv('data/朝阳区/villages.csv')


gdf = gpd.read_file('data/urban_villages_filtered.shp')
gdf = gdf.drop(columns= ['geometry'])
gdf.to_csv('data/urban_villages_filtered.csv')
# gdf=gdf.to_crs(3857)
# # print(gdf.crs)
