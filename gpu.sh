...
#SBATCH -o logging_ours/normal_new.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e logging_ours/normal_new.err  # File to which STDERR will be written, %j inserts jobid
