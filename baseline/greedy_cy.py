...
villages['year'] = villages.index // 6 + 1

# 7. Add constant fields
villages['FAR'] = 2.2
villages['r_c'], villages['r_r'], villages['r_poi'] = 0.4, 0.2, 0.4
# villages['r_c'], villages['r_r'], villages['r_poi'] = 0.7, 0.2, 0.1
...
villages.to_csv('baseline_csv/朝阳区/greedy_2.csv')
