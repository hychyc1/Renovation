    ...
    def run(self) -> Tuple[Plan, float]:
        ...
        for year in range(self.max_year):
            ...
            for _ in range(self.num_sample):
                ...
                # print(f"{candidate}, {r}", flush=True)
                if r > best_reward:
                    best_reward = r
                    best_plan   = candidate
            ...
            _, realised_r, _, info = self.env.step(best_plan)
            total_reward += realised_r
            print(best_reward, flush=True)
            # print(realised_r, flush=True)
            print(best_plan, flush=True)
